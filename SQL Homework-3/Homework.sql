...
(9, 7),
(10, 6); 
SELECT * FROM movies JOIN directors ON movies.director_id = directors.director_id WHERE movies.rating = 'R';
SELECT * FROM movies JOIN movie_genres ON movies.movie_id = movie_genres.movie_id JOIN genres ON movie_genres.genre_id = genres.genre_id WHERE EXTRACT(YEAR FROM movies.release_date) = 2019;
SELECT * FROM actors JOIN cast_members ON actors.actor_id = cast_members.actor_id JOIN movies ON cast_members.movie_id = movies.movie_id WHERE actors.nationality = 'American';
SELECT * FROM movies JOIN movie_production_companies ON movies.movie_id = movie_production_companies.movie_id JOIN production_companies ON movie_production_companies.company_id = production_companies.company_id WHERE movies.budget > 100000000;
SELECT * FROM movies JOIN movie_locations ON movies.movie_id = movie_locations.movie_id JOIN directors ON movies.director_id = directors.director_id WHERE movie_locations.city = 'London';
SELECT * FROM movies JOIN movie_genres ON movies.movie_id = movie_genres.movie_id JOIN genres ON movie_genres.genre_id = genres.genre_id JOIN cast_members ON movies.movie_id = cast_members.movie_id JOIN actors ON cast_members.actor_id = actors.actor_id WHERE genres.name = 'Horror';
SELECT * FROM movies JOIN reviews ON movies.movie_id = reviews.movie_id JOIN users ON reviews.user_id = users.user_id WHERE reviews.rating = 5;
SELECT * FROM directors JOIN movies ON directors.director_id = movies.director_id WHERE directors.nationality = 'British';
SELECT * FROM movies JOIN movie_genres ON movies.movie_id = movie_genres.movie_id JOIN genres ON movie_genres.genre_id = genres.genre_id WHERE movies.duration_minutes > 180;
SELECT * FROM movies JOIN movie_awards ON movies.movie_id = movie_awards.movie_id JOIN awards ON movie_awards.award_id = awards.award_id JOIN directors ON movies.director_id = directors.director_id WHERE awards.award_type = 'Oscar';


SELECT * FROM movies JOIN directors ON movies.director_id = directors.director_id;
SELECT * FROM actors JOIN cast_members ON actors.actor_id = cast_members.actor_id JOIN movies ON cast_members.movie_id = movies.movie_id;
SELECT * FROM movies JOIN movie_genres ON movies.movie_id = movie_genres.movie_id JOIN genres ON movie_genres.genre_id = genres.genre_id;
SELECT * FROM users JOIN reviews ON users.user_id = reviews.user_id JOIN movies ON reviews.movie_id = movies.movie_id;
SELECT * FROM movies JOIN movie_locations ON movies.movie_id = movie_locations.movie_id;
SELECT * FROM movies JOIN movie_production_companies ON movies.movie_id = movie_production_companies.movie_id JOIN production_companies ON movie_production_companies.company_id = production_companies.company_id;
SELECT * FROM actors JOIN actor_awards ON actors.actor_id = actor_awards.actor_id JOIN awards ON actor_awards.award_id = awards.award_id;
SELECT * FROM movies JOIN movie_awards ON movies.movie_id = movie_awards.movie_id JOIN awards ON movie_awards.award_id = awards.award_id;
SELECT * FROM users JOIN user_watchlist ON users.user_id = user_watchlist.user_id JOIN movies ON user_watchlist.movie_id = movies.movie_id;
SELECT * FROM movies JOIN movie_revenues ON movies.movie_id = movie_revenues.movie_id;